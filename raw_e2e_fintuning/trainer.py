...
def compute_raw_loss_from_logits(
    *,
    loss_type: str,
    ...
    raise ValueError(
        f"Unsupported raw loss type: {loss_type}. "
...
class RawAdaLoraCallback(TrainerCallback):
    def __init__(self, trainer: "_RawLossMixin"):
...
class _RawLossMixin:
    ...
    def compute_loss(self, model, inputs, return_outputs=False, num_items_in_batch=None, **kwargs):
        ...
        try:
            ...
            loss = compute_raw_loss_from_logits(
                loss_type=loss_type,
...
class RawFinetuneTrainer(_RawLossMixin, Trainer):
    pass


class RawFSDPFinetuneTrainer(_RawLossMixin, FSDPTrainer):
