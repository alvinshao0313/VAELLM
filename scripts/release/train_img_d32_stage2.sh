...
torchrun \
    ...
    --default_root_dir "bitvae_results/infinity_d32_stage2" --log_every 20 --ckpt_every 5000 --visu_every 5000 \
    ...
    --pretrained "bitvae_results/infinity_d32_stage1/checkpoints/model_step_499999.ckpt" --not_load_optimizer --multiscale_training $@