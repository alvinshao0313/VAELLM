...
def resolve_block_runtime_configs(
    ...
    for category in active_categories:
        resolved[category] = ResolvedCategoryRuntimeConfig(
            ...
            outlier_residual_vae_codebook_bits=int(resolve_category_value(args.codebook_bits, category)),
            outlier_residual_vae_codebook_dim=int(resolve_category_value(args.codebook_dim, category)),
