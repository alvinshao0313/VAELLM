...
def test_cli_accepts_new_losses_and_restricts_selective_mass():
    ...
    kd_partial_cfg = _e2e(["--loss_type", "kd_top_partial", "--top_k", "100", "--alpha", "0.4"])
    assert kd_partial_cfg.loss.loss_type == "kd_top_partial"
    assert kd_partial_cfg.loss.alpha == pytest.approx(0.4)
