...
def get_hadK(n, transpose=False):
    ...
    elif n % 148 == 0:  # Qwen2 7b intermediate
    ...
    elif n % 96 == 0:  # Qwen3 8B intermediate
        assert (is_pow2(n // 96))
        K = 96
        hadK = get_had96().T if transpose else get_had96()
    elif n % 68 == 0:  # Qwen 3 14b intermediate
        assert (is_pow2(n // 68))
        K = 68
...
def apply_exact_had_to_linear(module, had_dim=-1, output=False):
    ...
    if had_dim == -1:
        ...
        if output:
            ...
            n = W_.shape[1]
            W_ = hadamard_transform(W_.reshape(-1, n // had_dim, had_dim),
